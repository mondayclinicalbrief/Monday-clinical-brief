...
- **Budget (£20–£50 per year).** Independent digests covering multiple specialties. Weekly or fortnightly cadence. Reflection prompts usually included.
- **Mid-range (£100–£250 per year).** Specialty-specific services from professional societies or established publishers. Often bundled with journal access.
- **Premium (£300–£1,000+ per year).** Evidence-based medicine platforms such as UpToDate, DynaMed, or BMJ Best Practice. These are reference tools as much as digest services.
...
- A weekly or fortnightly digest covering the top journals in your specialty.
- Summaries of five to fifteen papers per issue.
- Reflection prompts or CPD-formatted entries.
- An archive you can search.
- A trial period with no card upfront.

What you will not always get:

- Full-text access to the underlying papers. Most services summarise openly available abstracts and link out to your institutional library.
- Coverage of every subspecialty. Thirty-one specialties is broad but some niches (medical genetics, clinical pharmacology) are better served by dedicated society outputs.
- Video or podcast formats. These usually sit in higher tiers.
...
- Deeper specialty coverage, including subspecialty tracks.
- Full-text commentary from named clinical editors.
- Integration with CPD portfolios or Royal College systems.
- Society membership bundled in.
...
- **Auto-renewal with no reminder.** Some services renew at a higher rate than your signup price. Read the terms.
- **Tiered content.** Headline pricing may not include the features you actually want. Check what sits behind each paywall.
- **Per-specialty pricing.** A few services charge by specialty track. If you cover two or three, costs compound.
- **VAT.** UK subscriptions generally include VAT; services billed from abroad may add it on top.
...
[Start your four-week trial](/#subscribe) and decide at the end of it whether £20 is the right answer for you.
