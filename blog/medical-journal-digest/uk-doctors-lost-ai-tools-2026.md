---
title: "Three AI Tools UK Doctors Lost in Six Weeks — And What Works in Their Place"
seoTitle: "UK Doctors AI Tools 2026: Three Lost in Six Weeks, And What Replaces Them | MCB"
metaDescription: "Between 23 April and May 2026, UK NHS clinicians lost access to OpenEvidence, ChatGPT for Clinicians, and Heidi Evidence. Here's what happened, why, and the UK-regulatory-compliant tools that still work."
...
faqs:
  - question: "Which AI tools have UK doctors lost access to in 2026?"
    answer: "Three in six weeks. ChatGPT for Clinicians launched on 23 April 2026 with UK and EEA accounts explicitly excluded at the verification step. OpenEvidence withdrew from the UK and EU on 28 April 2026. Heidi Evidence confirmed in May 2026 that UK NHS email addresses are blocked from enrolment. All three were point-of-care clinical Q&A tools."
  ...
  - question: "What can UK NHS clinicians use for clinical Q&A instead?"
    answer: "For UK-regulatory-compliant point-of-care Q&A, iatroX is the credible option in May 2026. It is MHRA-registered as a Class I medical device, carries UKCA marking, is UK-built, and retrieves answers grounded in NICE, CKS, and SmPC. Base tier is free for individual clinicians; paid specialty diplomas around £99/year. Heidi Scribe (the clinical documentation product, separately MHRA-cleared) also remains available — it is unaffected by the Heidi Evidence enrolment block."
  ...
  - question: "How long is the UK regulatory pause likely to last?"
    answer: "The pull-tool exclusions will probably ease as the UK regulatory framework lands later in 2026. The MHRA Medical Devices (Amendment) Regulations consultation closes 19 June 2026. The International Reliance Framework is planned for Autumn 2026. The National Commission on AI in Healthcare report is due later in the year. Realistic best case: a clearer regulatory pathway by Q1 2027. Worst case: longer."
  - question: "Is The Monday Clinical Brief affected by these withdrawals?"
...
We have written individual explainers for each: [the OpenEvidence withdrawal](/blog/medical-journal-digest/openevidence-alternative-uk/), [the ChatGPT for Clinicians exclusion](/blog/medical-journal-digest/chatgpt-for-clinicians-uk/), and [the Heidi Evidence NHS-email block](/blog/medical-journal-digest/heidi-evidence-uk-nhs-excluded/). This post pulls the thread.
...
**Friday afternoon — five minutes to log and reflect.** What did you read? What changed in how you think about it? One sentence on each. CPD evidence in five minutes. Use the [MCB CPD Tracker](https://cpd.mondayclinicalbrief.co.uk) if you want the workflow built around exactly this rhythm; FourteenFish if you already use it.
...
[Subscribe to The Monday Clinical Brief](/#subscribe) for the literature half of the problem. £20 a year. Four-week free trial. Thirty-one specialties.
