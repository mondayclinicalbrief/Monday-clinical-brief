...
faqs:
  ...
  - question: "When should metformin still be used as first-line under NG28 2026?"
    answer: "Metformin remains a legitimate first-line option for patients with a contraindication or intolerance to SGLT2 inhibitors. These include active diabetic ketoacidosis, recurrent or severe genitourinary infection, significant volume depletion, severe foot disease (especially with prior amputation), an inability to follow sick-day rules safely, and patient preference after informed discussion. Metformin is also the first-line choice during pregnancy or breastfeeding where indicated."
  - question: "What are the key cautions when initiating an SGLT2 inhibitor?"
    answer: "Three cautions stand out. Euglycaemic diabetic ketoacidosis: rare but serious, more likely with intercurrent illness, fasting, low-carbohydrate diet, or alcohol. Genitourinary infections: thrush and uncomplicated UTI are common, especially in the first months. Foot care: routine foot examination at initiation and continued vigilance, particularly for patients with prior ulcer or amputation. Volume depletion should also be considered in elderly patients on diuretics."
  - question: "What sick-day rules should patients on an SGLT2 inhibitor know about?"
    answer: "Patients should pause their SGLT2 inhibitor during acute illness — particularly vomiting, severe diarrhoea, sepsis, or surgery — until they are eating and drinking normally and not at risk of dehydration. Ketone testing is reasonable for symptomatic patients, especially those with concurrent type 1 features or on a low-carbohydrate diet. NICE NG28 2026 codifies the sick-day conversation as part of initiation, not an afterthought."
  - question: "Does this update change prescribing for patients already on metformin?"
