...
If you want clinical AI that carries no advertising and is available to UK doctors, the practical list in 2026 is short. For keeping up with the literature, there is **The Monday Clinical Brief**. For point-of-care questions, there are **iatroX**, **Heidi Evidence** (out of session, and not on NHS accounts), and two newer UK-focused entrants, **Praxis Medicine** and **Umbil**. This page explains what each one does, what it costs, and the job it is built for.
...
**UK status:** available. UK-built, MHRA-registered as a Class I device, UKCA-marked.
**Not for:** systematic weekly coverage. It responds to queries, not calendars.
